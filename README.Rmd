...
In general, the function seems to work best when you DON'T include "stargazer_call =" in the function call, so best to leave that out and simply enter the stargazer call as the first parameter without explicitly identifying it.
