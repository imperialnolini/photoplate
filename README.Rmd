...
All done! Let's look at the LaTeX file (created with [this](auxiliaries/latex_file.tex) code then converted into a JPEG to display here, though the PDF itself is [here](auxiliaries/latex_file.pdf)):
