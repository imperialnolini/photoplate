...
All done! Let's look at the LaTeX rendering of the photoplate() LaTeX table made (see [here](auxiliaries/latex_file.tex) for the .tex file used to create the document and [here](auxiliaries/latex_file.pdf) for the original PDF):
