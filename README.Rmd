...
In general, the photoplage::photoplate() function seems to work best when "stargazer_call = "  is NOT included in its function call, so best to leave that out and simply enter the stargazer::stargazer() call as the first parameter without explicitly identifying it as such.
