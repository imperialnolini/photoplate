...
We'll generate 10000 datapoints for our analysis. Let's sample with replacement from 0 to 10000000 for x1 and x2, our two explanatory variables, and from 0.0001 to 1 without replacement for e, our error. Then, we'll calculate values of y per the betas defined above. The data generation:
```{r generate data}
base::set.seed(1)
